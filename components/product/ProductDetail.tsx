    ...
    <>
      ...
      <div className="min-h-screen bg-bg-site font-sans md:px-48 w-full">
        ...
        <div className="px-4 md:px-28 py-8">
          {/* ── Top: Gallery + Info ── */}
          <div className="flex justify-center md:grid md:grid-cols-[2fr_1.8fr] items-center gap-8 md:gap-0 mb-14">

            {/* Gallery */}
            <div className="flex flex-col gap-3 border border-red-500">
              <div className="w-[700px] object-contain p-8 duration-200 overflow-hidden border border-slate-300 rounded-4xl hover:bg-white transition relative">
            ...
            {/* Info */}
            <div className="flex flex-col gap-5 border border-amber-500">
