            ...
            <div className="flex flex-col gap-5  pt-20">
              ...
              <div className="flex gap-x-5 items-center">
                ...
                <div className="relative">
                  ...
                  <div className="w-10 h-10 rounded-full border-2 border-third bg-primary flex items-center justify-center font-semibold text-[18px] text-third -m-px absolute top-[-12px] right-[5px] z-10">
                    {qty}
                  </div>
