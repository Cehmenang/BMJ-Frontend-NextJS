...
export default function AdminNav(){
    ...
    return (
        <>
            ...
            <div className={`fixed bottom-6 md:bottom-[200px] right-4 md:right-7 z-50 ${links ? 'translate-x-0' : 'translate-x-[200px]'} transition-all flex flex-col bg-second border-2 border-third p-3`}>
                {pages.map(page=>{
