    ...
    return (
        <>
            <button className="diskusi fixed bottom-6 md:bottom-20 right-4 md:right-7 bg-second p-4 rounded-full z-50" onClick={()=>links ? setLinks(false) : setLinks(true)}>
                <Navigation size={30} className="white" stroke="2"/>
            </button>
            <div className={`fixed bottom-6 md:bottom-[200px] right-4 md:right-7 z-50 ${links ? 'translate-x-0' : 'translate-x-[280px]'} transition-all flex flex-col bg-second border-4 border-third rounded-md`}>
